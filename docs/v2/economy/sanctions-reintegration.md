# Sanctions Unwinding & International Reintegration
...
Iran's case is distinctive not only because of the scale of its sanctions burden — the most complex multilayered coercive architecture ever applied to a mid-size economy — but because of the political economy it has created domestically. Decades of exclusion from international finance have given rise to parallel currency markets, alternative payment networks, and smuggling infrastructure controlled largely by security-connected actors who benefit economically from the continuation of sanctions. The very actors with the greatest organizational capacity to resist sanctions are also the actors with the greatest political incentive to resist their removal.

Comparative evidence from South Africa, Myanmar, Cuba, and Iran's own partial experience under the 2015 Joint Comprehensive Plan of Action (JCPOA) illustrates a consistent finding: economic recovery after sanctions is slower and more uneven than the decline during their imposition. This asymmetry arises because sanctions create distributional changes — concentrating economic power in particular hands — that persist even when the formal measures are withdrawn. International firms that entered the Iranian market during the JCPOA's brief window and then faced renewed US secondary sanctions after the 2018 withdrawal would require extraordinary institutional assurances before re-engaging, creating a credibility problem that purely technical policy reforms cannot solve.

For observers interested in Iran's future — whether that involves a negotiated diplomatic settlement, a political transition, or a gradual evolution of the current system — understanding the mechanics of sanctions unwinding is essential. The obstacles are not primarily technical but institutional and political: how to rebuild correspondent banking relationships, how to meet international financial compliance standards, how to manage the domestic political resistance of actors whose economic position depends on sanctions persistence, and how to make international commitments credible enough to attract investment given the JCPOA's history of reversal.

## Theoretical Framework

The academic literature on sanctions unwinding draws on three distinct theoretical traditions that this page synthesizes into an integrated analytical framework. The first is the international political economy literature on economic coercion, anchored in Clayton, Maggiori, and Schreger's (2024) theory of coercion and fragmentation, which establishes the "hysteresis" principle: sanctions create structural changes in targeted economies that do not automatically reverse when the measures are removed. Supply chain reconfigurations, the atrophy of financial linkages, and the emergence of alternative trade networks represent path-dependent adaptations whose reversal requires active institutional reconstruction rather than passive normalization.

The second tradition is the distributional political economy literature, exemplified by Ghomi (2021) and Draca et al. (2022), which analyzes who benefits and who loses from both sanctions imposition and their removal. This literature establishes that sanctions are not distributionally neutral — they systematically concentrate economic power among actors with access to state-controlled resources, smuggling networks, and currency arbitrage — and that the post-sanctions political economy therefore has identifiable vested interests in sanctions persistence. This distributional framing transforms sanctions unwinding from a technical trade policy question into a political economy problem: unwinding creates losers among politically powerful actors, generating organized resistance that any reintegration process must overcome.

The third tradition is the credible commitment literature in institutional economics, which asks how states signal that policy changes are durable rather than reversible. This literature is directly relevant to Iran's reintegration challenge because the JCPOA demonstrated that sanctions relief can be reversed, fundamentally altering the risk calculus of international investors. Institutions that reduce reversibility risk — bilateral investment treaties, binding arbitration frameworks, independent central banks, FATF compliance — become prerequisites for meaningful reintegration rather than optional enhancements. The credible commitment framework also illuminates the domestic political requirements for sustained reintegration: international actors will only make irreversible investments if they believe the domestic political conditions supporting reintegration will persist.

This page's analytical architecture organizes evidence along a CMO (context-mechanism-outcome) framework. The context is Iran's specific sanctions architecture — three layered institutional structures (UN, US, EU) with different legal bases and removal procedures. The mechanisms include financial normalization (SWIFT reintegration, correspondent banking restoration, FATF compliance), trade and investment opening (energy sector recapitalization, investment treaty frameworks, insurance and shipping access), and domestic political economy management (addressing IRGC-connected vested interests, managing distributional conflicts, building credible governance signals). The outcomes of interest range from partial reintegration — restoring basic trade and investment flows — to full normalization — achieving something approaching the economic relationships of a comparable non-sanctioned economy. The dominant scholarly debate concerns whether full normalization is achievable within a political generation given the depth of structural adaptation, or whether the most realistic scenario involves indefinite partial reintegration.
...
The Joint Comprehensive Plan of Action (JCPOA) of 2015 provided a critical diagnostic moment. Between 2016-2018, Iran experienced partial sanctions relief following nuclear verification compliance. Yet even this limited relief revealed the structural obstacles embedded in the regime. US primary sanctions on designated entities (particularly the Islamic Revolutionary Guard Corps and its affiliates) remained in place despite nuclear compliance, signaling that Iran's reintegration operates on two separate tracks—nuclear and non-nuclear—that may prove incompatible institutionally.

Comparison with precedents illustrates this distinctiveness. South Africa's sanctions unwinding (1989-1994) involved coordinated multilateral de-escalation under clear political conditions (regime change). Myanmar's sanctions modulation (2011 onwards, then reversal post-2021 coup) operated within regional consensus frameworks. Cuba's embargo, while unilateral and persistent, maintained ideological justification without the structural fragmentation evident in Iran. Iran's case differs: nuclear compliance does not automatically trigger sanctions relief, creating a credibility problem for future negotiation frameworks.

The IRGC designation complicates sectoral relief pathways. The Guards control major economic sectors—telecommunications, energy infrastructure, transport—making any sanctions lifting technically difficult without addressing non-proliferation concerns. The comprehensive SWIFT disconnection (2012-2018) restructured Iran's financial architecture toward cash settlement and alternative payment systems, institutionalizing the sanctions themselves into operational banking and trade infrastructure that persists even during negotiations.
...
1. Congressional Codification: US sanctions depend increasingly on legislation (Countering America's Adversaries Through Sanctions Act [CAATSA], Iran Sanctions Act [ISA]) rather than executive order. Legislative codification creates political barriers to reversal—executive action alone cannot unwind congressionally mandated sanctions, requiring new legislative votes that face institutional friction.

2. Compliance Infrastructure: Financial institutions, insurance companies, and multinational firms develop compliance departments and risk-assessment procedures around sanctions regimes. These institutional procedures, once embedded, become self-perpetuating—they reduce sanctions-related risk but also increase the internal cost of reversal (retraining, policy updates, regulatory uncertainty).
...
Iran's reintegration challenge differs from historical precedents due to three structural factors created by the sanctions regime itself:

Economic Adaptation and Dual-Use Development: The twelve-year intensification of sanctions (2006-2018) forced Iranian economic actors to develop sanctions-busting supply chains and alternative technologies. The oil sector, cut off from international markets, invested in enhanced oil recovery and downstream capacity to maximize value from reduced export volumes. Petrochemical sectors developed domestic feedstock substitutes. These adaptations are now economically rational within the sanctions environment but become suboptimal if international integration is restored. A firm maximizing production under sanctions constraints may face efficiency losses when competing with integrated global supply chains post-relief.

IRGC Economic Interests and Sectoral Relief Complications: The IRGC's designation as a terrorist organization (US designations) prevents normal banking relationships and direct sanctions relief even for non-proliferation sectors. The Guards operate in telecommunications (MTN subsidiary), energy (Mapna Group), and port operations. Meaningful sanctions relief requires either de-designation (politically untenable) or sectoral carve-outs (legally problematic under CAATSA). This creates a structural veto on reintegration—Iran cannot fully reintegrate without involving designated entities, yet the international system cannot relieve sanctions on designated entities without political change in Washington.

SWIFT Disconnection Legacy: Iran's removal from SWIFT (2012) and subsequent development of alternative payment systems (SEPAM, bilateral clearing arrangements with China and Russia) created path-dependent financial infrastructure. Even if re-connected, Iran's financial sector faces years of rebuild costs for correspondent banking relationships, compliance certifications, and technical integration. Meanwhile, alternative payment systems are now embedded in Iran-China trade patterns, reducing the institutional pressure to normalize.
...
| 4 | The economic impact of the lifting of sanctions on tourism i... | ["Stephen Pratt", "Valiollah Alizadeh"] | 2017 | 4.0 | 4.6 |
...
| 7 | U.S.-Imposed Economic Sanctions on Iran in the COVID-19 Cris... | ["Abbas Karimi", "Hojjat Salimi Turkamani"] | 2021 | 4.0 | 4.6 |
| 8 | How Do International Conflicts Impact China’s Energy Securit... | ["Xiaoxiao Hu", "Ling Ling He", "Qi Cui"] | 2021 | 4.0 | 4.6 |
