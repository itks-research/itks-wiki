...
**Militia-to-party transformation theory** (Loyle 2021): The conditions enabling transformation include: competitive electoral systems offering real power-sharing, international security guarantees for leadership, and economic incentives. Lebanon's Hezbollah represents the hybrid case — never demobilized but transformed into a political party while retaining armed capacity. Iraq's PMF represents a failure case — nominally integrated into security sector but retaining independent command chains.

**IRGC parallel**: The IRGC is structurally more similar to the Iraqi PMF than a conventional military, with independent revenue streams (bonyad system, smuggling networks), parallel governance, and a political role in Iranian elections. Standard DDR approaches are inapplicable — the relevant framework is militia-to-political-institution transformation.
...
**IRGC vs. Iraqi military comparison:**
- Iraq 2003: Army dissolved by CPA Order 2, creating immediate armed unemployment. IRGC dissolution would similarly create an armed unemployed class — but IRGC members have economic assets (not just military skills) that provide alternative livelihoods.
- Iraq PMF: Emerged from the post-dissolution vacuum, funded by Iran. IRGC regional militias are already organized and funded — they would not need external sponsorship to persist.

**Fragmentation scenario conditions:**
If the Islamabad talks collapse and conflict resumes, the most likely fragmentation vector is not ethnic (Iran's ethnic minorities lack current military capacity) but institutional — IRGC regional commands versus Tehran central authority. The Quds Force's external network (already degraded by proxy defeats) is the most likely source of continued armed resistance to any imposed settlement.

**DDR applicability to IRGC**: Standard DDR is inapplicable. The relevant framework is conditional legalization: offering IRGC economic assets legal protection in exchange for military demobilization and political withdrawal. This follows the Colombian FARC model more than the Iraqi model.