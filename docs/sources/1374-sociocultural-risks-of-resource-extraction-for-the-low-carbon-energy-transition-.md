...
| **Citation Count** | 20 |
| **Source** | openalex |
| **DOI** | [10.1016/j.exis.2024.101478](https://doi.org/10.1016/j.exis.2024.101478) |
| **Full Text** | [Open Access](https://doi.org/10.1016/j.exis.2024.101478) |
...
- **extends** [Spatializing energy justice](0851-spatializing-energy-justice.md)
- **extends** [Overview of forest tenure reforms in Indonesia](1564-overview-of-forest-tenure-reforms-in-indonesia.md)
- **extends** [From Disruption to Stabilization: A Functional Governance Perspective on the Renewable Energy Transition in Montenegro](2209-from-disruption-to-stabilization-a-functional-governance-perspective-on-the-rene.md)
- **extends** [Identifying scenarios for renewable energy development in Iran: the role of collaborative governance](3007-identifying-scenarios-for-renewable-energy-development-in-iran-the-role-of-colla.md)
- **extends** [Decarbonization and its discontents: a critical energy justice perspective on four low-carbon transitions](0184-decarbonization-and-its-discontents-a-critical-energy-justice-perspective-on-fou.md)
- **extends** [RETRACTED: Legal responses to energy security and sustainability in Nigeria's power sector amidst fossil fuel disruptions and low carbon energy transition](1162-retracted-legal-responses-to-energy-security-and-sustainability-in-nigerias-powe.md)
