# Navigating sustainability: Unveiling the interconnected dynamics of <scp>ESG factors</scp> and <scp>SDGs</scp> in <scp>BRICS</scp> ‐11

| Field | Value |
|-------|-------|
| **Authors** | Cem Işık, Serdar Ongan, Hasibul Islam, Stefania Pinzón, Gul Jabeen |
| **Year** | 2024 |
...
| **Citation Count** | 136 |
| **Source** | openalex |
| **DOI** | [10.1002/sd.2977](https://doi.org/10.1002/sd.2977) |
| **Full Text** | [Open Access](https://onlinelibrary.wiley.com/doi/pdfdirect/10.1002/sd.2977) |
