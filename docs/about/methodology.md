...
**Collection process** begins with research directives—targeted search tasks specifying a case study and category (e.g., "Find sources about military transition in South Korea"). The engine generates multiple search queries, deduplicates against existing records, and stores new sources. The system maintains 9,383+ sources across 11 case studies.
