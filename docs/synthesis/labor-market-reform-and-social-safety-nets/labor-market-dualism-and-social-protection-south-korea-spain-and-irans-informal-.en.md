...
Despite substantial comparative research on labor market transitions, several critical gaps limit confident prescription for Iran:

- **Digital platform economy**: How gig work and platform-mediated labor alter traditional formal/informal dualism dynamics in transition contexts is poorly understood; most comparative evidence predates the platform economy.
- **Gender-disaggregated outcomes**: Longitudinal data on how labor market formalization affects women workers specifically during transitions is sparse, particularly in societies transitioning from gender-restrictive labor codes.
- **Sanctions-to-reform sequencing**: No clear evidence exists on the optimal sequence for labor market reform under sanctions unwinding — whether to liberalize labor markets before or after foreign investment resumes.
- **Iran-specific informality estimates**: Reliable estimates of Iran's informal sector size (likely 30–50% of employment) are contested; without accurate baselines, reform impact modeling is unreliable.
- **Union formation dynamics**: How labor organizing emerges in post-authoritarian contexts with pre-existing state-controlled unions (like Iran's Islamic Labour Councils) is understudied relative to contexts without prior corporatist labor institutions.

## Summary for General Readers

In every major economic transition, the labor market splits into two tiers: formal workers with contracts, benefits, and legal protections, and informal workers with none of these. South Korea and Spain show that this split tends to deepen during early transition even with strong growth, and that reversing it requires simultaneously reforming labor law, social insurance systems, and enforcement capacity. For Iran — where an estimated one-third to half the workforce operates informally — the lesson is that labor market reform cannot be treated as a technical afterthought; it determines whether transition benefits reach ordinary workers or are captured by those already inside the formal economy.