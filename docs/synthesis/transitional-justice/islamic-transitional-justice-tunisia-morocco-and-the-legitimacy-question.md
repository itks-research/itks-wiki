...
Morocco's earlier Equity and Reconciliation Commission (IER), established in January 2004, provides a complementary case. The IER investigated approximately 20,000 cases of violations spanning 1956-1999, recommending financial, psychological, and medical reparations alongside constitutional reform. As the first truth commission in the Arab world, Morocco demonstrated that TJ mechanisms can operate within Muslim-majority societies, though the IER operated under royal patronage rather than democratic mandate. Together, Tunisia and Morocco show both the viability and the vulnerability of TJ in Islamic contexts -- a pattern directly relevant to any future Iranian process.
...
The risk is co-optation. Regime-affiliated clerics could redefine these concepts to justify impunity, framing blanket amnesty as sulh or characterizing prosecution as un-Islamic vengeance. Any Islamic TJ framework for Iran would require development with independent religious scholars -- those in the Qom seminaries who have maintained distance from the political establishment, as well as diaspora-based scholars -- rather than regime-linked institutions like the Guardian Council or Special Clerical Court.

## Open Research Questions

- Can qisas and diya mechanisms be adapted for mass atrocity contexts where individual perpetrator-victim relationships are diffused across institutional chains of command?
- How would an Islamic TJ framework interact with international legal obligations, particularly where qisas-based victim choice might conflict with ICC requirements for prosecution of crimes against humanity?
- Which Iranian religious scholars -- inside the country and in diaspora -- have the scholarly authority and political independence to develop Islamic TJ frameworks without regime co-optation?

## Sources

| Source | Key Finding | ID |
|--------|------------|-----|
| Kazemi (2019) | Religious principles in local TJ can both facilitate and hinder TJ goals | 747 |
...
**Structural Parallels:** Tunisia's IVD represents the closest operational parallel — an Arab-Muslim society attempting systematic accountability for decades of authoritarian abuse. The parallel holds for the ambition (62,354 complaint files mirror the scale Iran would face) and for the Islamic jurisprudential resources available. However, Tunisia was a secular authoritarian state with an Islamist opposition; Iran is a theocratic state with a partially secular opposition. This inverts the TJ dynamic: in Tunisia, Islamic concepts offered an alternative legitimacy framework to the secular state's justice system; in Iran, Islamic concepts risk being co-opted by the very institutions responsible for violations. Morocco's IER model — operating under royal patronage without full independence — offers a cautionary parallel for any Iranian process that remains under establishment influence. The Shi'a jurisprudential tradition offers resources absent from the Sunni-majority Tunisian and Moroccan contexts: مظلومیت (mazlumiyyat, the justice of the oppressed) and the Karbala narrative provide culturally resonant frameworks for victim-centered justice that could bridge secular human rights discourse and religious sensibility.
