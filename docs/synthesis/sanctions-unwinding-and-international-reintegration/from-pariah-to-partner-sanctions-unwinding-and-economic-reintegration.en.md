...
- **Limited empirical evidence on hysteresis duration and reversal mechanisms:** Clayton, Maggiori, and Schreger's theoretical framework for economic coercion and fragmentation (hysteresis effects) is well-grounded, but empirical evidence on how long structural distortions persist after sanctions removal, and what policy interventions accelerate reversal, is thin. South Africa's post-apartheid and Myanmar's partial opening are cited but neither involves sanctions regimes of comparable duration, scope, or sectoral specificity to Iran's.

- **JCPOA as a partial natural experiment has limited generalizability:** The 2015–2018 JCPOA experience provides direct evidence on Iranian market responses to partial sanctions relief, but its brevity and the unusual mechanism of US unilateral withdrawal limit its generalizability. Evidence on FDI, trade, and financial sector responses under a more durable and comprehensive sanctions removal remains hypothetical.

- **Absence of rigorous data on the scale of Iran's parallel financial system:** The article identifies hawala networks, cryptocurrency channels, and IRGC-controlled currency exchange as components of a parallel financial system that would not dissolve with sanctions removal, but there is no rigorous empirical measurement of the size, institutional structure, or political economy of this system. Its ability to compete with or undermine formal reintegration is asserted but not quantified.

- **FATF compliance political economy undertheorized:** The article identifies FATF compliance as a prerequisite for banking reintegration and notes that the Guardian Council and Expediency Council blocked relevant legislation. However, the conditions under which these institutional blockers might accept FATF compliance as a transitional trade-off — and whether partial compliance could achieve meaningful banking access — are not analyzed in the academic literature reviewed.

- **Distributional effects of sanctions lifting on regime-connected actors lack empirical grounding:** The article argues that sanctions lifting does not automatically redistribute concentrated economic power from IRGC-connected actors and may amplify it. While theoretically coherent, the specific mechanisms by which connected actors would capture the benefits of reintegration — and what institutional safeguards could prevent this — require empirical analysis that the comparative cases do not fully provide.

This article examines what it would actually take for Iran to rejoin the global economy after decades of multilayered sanctions, drawing on the short-lived 2015–2018 nuclear deal and comparative cases like South Africa and Myanmar. The central finding is that decades of sanctions do not simply reverse when lifted: Iran's economy has been structurally reshaped around sanctions-resistance, with underground financial networks, import substitution industries, and IRGC-controlled trade monopolies that would survive formal sanctions removal and actively resist genuine reintegration. The article argues that the actors who have profited most from sanctions — smuggling networks, currency arbitrageurs, military-controlled import monopolies — are also among Iran's most politically powerful, making economic reintegration fundamentally a political challenge, not merely a technical or diplomatic one.