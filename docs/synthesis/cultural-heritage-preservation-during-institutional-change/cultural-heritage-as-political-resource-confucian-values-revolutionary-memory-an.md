...
Significant gaps limit understanding of cultural heritage dynamics in the Iranian transition context:

- **Post-theocratic heritage politics**: The specific dynamics of cultural heritage mobilization in a post-theocratic transition — where the incumbent regime's identity was itself built on religious legitimation — represent an understudied category distinct from post-military and post-communist precedents.
- **Ethnic minority heritage effects**: How pre-Islamic Persian heritage appeals interact with the cultural identities of non-Persian minorities (Kurds, Arabs, Baloch, Azeris) — whether they unify or further fragment national identity — is poorly researched.
- **Digital heritage activism**: How social media accelerates the speed and reach of heritage-based political mobilization, and whether this changes the stability of heritage as a transitional legitimation resource, is not yet well-studied.
- **Survey data limitations**: Reliable polling on Iranian public attitudes toward pre-Islamic Persian identity versus Islamic identity, and their relationship to political preferences, is extremely limited due to survey methodology constraints in authoritarian contexts.
- **Elite vs. popular heritage**: Whether the pre-Islamic identity mobilization observable among diaspora and educated urban populations reflects broader Iranian public sentiment or represents elite projection is empirically unresolved.

## Summary for General Readers

Every major political transition involves a struggle over history: which past does the new order claim legitimacy from, which memories are rehabilitated, which are suppressed? For Iran, this plays out as a tension between Islamic revolutionary memory and pre-Islamic Persian heritage — Cyrus the Great versus Imam Khomeini. South Korea showed that deploying Confucian heritage selectively for developmental legitimation can work, but that overreach (claiming cultural continuity where the break was real) undermines credibility. For Iran, a post-transition government that suppresses Islamic heritage to privilege pre-Islamic identity will alienate devout populations; one that ignores pre-Islamic Persian identity will lose nationalist legitimacy. A pluralist cultural policy — acknowledging both without instrumentalizing either — is difficult but empirically better-supported by comparative evidence.