...
Major gaps limit application of Indonesia's decentralization lessons to Iran:

- **Parallel security apparatus interaction**: How decentralization interacts with a parallel military-commercial structure like the IRGC — which operates outside provincial governance — is not addressed in standard decentralization literature; Indonesia had no comparable institution.
- **Resource revenue decentralization**: Whether fiscal decentralization should include sub-national shares of oil and gas revenue (as Indonesia did) or concentrate resource revenue centrally is contested, with evidence pointing in conflicting directions.
- **Ethnic conflict and decentralization timing**: The optimal sequencing of ethnic tension management and fiscal decentralization (which came first in Indonesia with problematic results) remains unclear for contexts with higher ethnic mobilization.
- **Digital accountability tools**: Whether e-governance and digital public financial management systems can substitute for slow-developing local audit capacity is largely unresolved by existing evidence.
- **Iran's provincial capacity baseline**: Reliable data on current capacity and institutional quality of Iran's 31 provinces — necessary for calibrating any decentralization design — is not publicly available.

## Summary for General Readers

Indonesia's "big bang" decentralization — transferring enormous fiscal authority to local governments almost overnight after Suharto's fall — is a cautionary tale about speed without preparation. Local governments gained large budgets before they had functional accounting systems, audit bodies, or civil servants trained to manage them, and corruption surged predictably. For Iran, which would face pressure to decentralize power to provinces with large ethnic minority populations (Kurdistan, Khuzestan, Sistan-Baluchestan), the lesson is not to avoid decentralization but to build local institutional capacity — financial management systems, accountability mechanisms, trained civil servants — before transferring fiscal authority, not simultaneously or after.