...
1. **Diyanet's internal diversity**: Turkey's Directorate of Religious Affairs is often treated as a monolithic institution, but it contains reformist and traditionalist factions. How does internal Diyanet politics affect its output — religious pronouncements, education content, international outreach?

2. **Efficacy of state religious control**: The premise of the Diyanet model is that state-controlled religious institutions moderate extremism. What evidence exists that Diyanet-trained imams are actually less susceptible to radical influence than market-based religious provision (private mosques, foreign-funded institutions)?

3. **Export effects**: Turkey's AKP-era Diyanet has dramatically expanded international operations, funding mosques and Islamic education in Central Asia, the Balkans, and Germany. How does this export model interact with the domestic legitimacy function?

4. **Post-theocratic alternatives**: For a post-velayat-e faqih Iran, the Diyanet model offers a path to institutional continuity (maintain a state religious body) without theocratic authority. But Iran's clerical establishment is far more institutionally powerful than Turkey's — could a Diyanet-like model be negotiated with Qom hawza leadership, or would it require their defeat?
